...
plot "./heat.dat" using 1:2 axes x1y1 title "Specific Heat" with linespoints lc rgb 0xFF0000, \
     "./fb.dat" using 1:2 axes x1y2 title "stripe order"  with linespoints lc rgb 0x0000FF
