...
set xlabel "Stripe Region, After First Order"
plot "hex.dat" using 1:2 with lines dt 2 lc rgb "blue", \
     "./hist_configs/7_9_24/aFO_rot0_hist.dat" using 1:2 with points pt 7 lc rgb "red", \
     "./hist_configs/7_9_24/aFO_rot3_hist.dat" using 1:2 with points pt 7 lc rgb "red", \
     "./hist_configs/7_9_24/aFO_rot4_hist.dat" using 1:2 with points pt 7 lc rgb "red", \
     "./hist_configs/7_9_24/aFO_rot5_hist.dat" using 1:2 with points pt 7 lc rgb "red"
