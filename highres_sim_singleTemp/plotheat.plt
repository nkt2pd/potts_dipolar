...
# plot "./L=36/DJ0.025000/heat.dat" using 1:2 title "Specific Heat" with points lc rgb 0xFF0000, \
#      "./L=36/DJ0.025000/Potts_m.dat" using 1:2 title "Potts Order" with points lc rgb 0x00FF00
# pause -1
# plot "./L=48/DJ0.025000/heat.dat" using 1:2 title "Specific Heat" with points lc rgb 0xFF0000, \
#      "./L=48/DJ0.025000/Potts_m.dat" using 1:2 title "Potts Order" with points lc rgb 0x00FF00
# pause -1
# plot "./L=60/DJ0.025000/heat.dat" using 1:2 title "Specific Heat" with points lc rgb 0xFF0000, \
#      "./L=60/DJ0.025000/Potts_m.dat" using 1:2 title "Potts Order" with points lc rgb 0x00FF00
