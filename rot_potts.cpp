...
int main() {
    ...
    for(int rot_num = 0; rot_num < 6; rot_num++) {
        ...
        std::string file_name_in =  "C:\\users\\quent\\Projects\\Research\\potts_dipolar\\potts_dipolar\\highres_sim_singleTemp5\\L=48\\DJ0.750000\\T=" + T_name + "_config.dat";
        std::string file_name_out = "C:\\users\\quent\\Projects\\Research\\potts_dipolar\\potts_dipolar\\rot_configs\\DJ0.75_T1.1\\DJ0.750000_T" + T_name + "_rot" + rotnum_name + "_config.dat";
